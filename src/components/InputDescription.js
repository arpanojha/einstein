...
const InputDescription = () => {
    ...
    const onsubmit = async(e) =>{
        ...
        try {
            ...
            //recipes = recilist.map((obj) => ({"reciname": obj.name}))
            const descr = name
            recipes = recilist[0]['name']
            const body = {recipes,descr}
            const response = await fetch(faster_than_light+"add_recipe_description",{
                method: "POST",
    ...
    return (
        ...
        <Fragment>
            ...
            <h1 className="text-center mt-5">Recipe Descriptions</h1>
